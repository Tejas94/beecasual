        				...
        				<div class="col-md-6 col-sm-12 col-xs-12 product-viewer clearfix">
        					...
        					<div id="product-image-carousel-container">
        						<ul id="product-carousel" class="celastislide-list">
	        						<li class="active-slide"><a data-rel='prettyPhoto' href="images/products/big-shoe1.jpg" ><img 

src="images/products/thumbnails/shoe1.jpg" alt="Shoe photo 1"></a></li>
	        						<li><a data-rel='prettyPhoto' href="images/products/big-shoe2.jpg"><img 

src="images/products/thumbnails/shoe2.jpg" alt="Shoe photo 2"></a></li>
	        						<li><a data-rel='prettyPhoto' href="images/products/big-shoe3.jpg"><img 

src="images/products/thumbnails/shoe3.jpg" alt="Shoe photo 3"></a></li>
	        						<li><a data-rel='prettyPhoto' href="images/products/big-shoe4.jpg"><img 

src="images/products/thumbnails/shoe4.jpg" alt="Shoe photo 4"></a></li>
	        						<li><a data-rel='prettyPhoto' href="images/products/big-shoe5.jpg"><img 

src="images/products/thumbnails/shoe5.jpg" alt="Shoe photo 5"></a></li>

        					</ul><!-- End product-carousel -->
        					</div>

        					<div id="product-image-container">
        						<figure><img src="images/products/big-shoe1.jpg" alt="Product Big image" id="product-image" data-

big="images/products/big-shoe1.jpg">
                        ...
                        <hr>
							<div class="product-add clearfix">
								<div class="custom-quantity-input">
									...
									<a href="#" onclick="return false;" class="quantity-btn quantity-input-up"><i class="fa fa-

angle-up"></i></a>
									<a href="#" onclick="return false;" class="quantity-btn quantity-input-down"><i class="fa fa-
...
fugiat temporibus soluta maxime doloremque alias enim officia aperiam at similique quae vel sapiente nulla molestiae tenetur deleniti architecto ratione accusantium.
        										</p>
        										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti in 

impedit modi aliquid explicabo aperiam illum esse quibusdam aspernatur commodi voluptate veritatis vero quidem porro vitae non nihil architecto optio!</p>
...
officiis consequatur expedita nesciunt voluptates at enim. Reprehenderit possimus vitae dolor tempore earum nulla maxime delectus repellendus excepturi suscipit qui?

</p>
        									</div><!-- End .tab-pane -->
        									
        									<div class="tab-pane" id="description">
												<p>The perfect mix of portability and performance in a slim 1" form 
