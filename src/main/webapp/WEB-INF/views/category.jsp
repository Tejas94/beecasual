...
<td><a href="editCategory-{{c.categoryId}}"/><span class="glyphicon glyphicon-pencil" style="color:green"></span></td>
<td><a href="deleteCategory-{{c.categoryId}}"/><span class="glyphicon glyphicon-trash"></span></td>
</tr>
